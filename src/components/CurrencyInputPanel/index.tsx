    ...
    <InputPanel id={id}>
      <Container hideInput={hideInput}>
        {!hideInput && (
          <LabelRow>
            <RowBetween>
              <Text color="background" fontSize="14px">{translatedLabel}</Text>
              {account && (
                <Text color="background" onClick={onMax} fontSize="14px" style={{ display: 'inline', cursor: 'pointer' }}>
